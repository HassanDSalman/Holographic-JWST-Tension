...
# rcParams['mathtext.fontset'] = 'cm' # تم تعطيل هذا السطر مؤقتاً لتجنب مشاكل العنوان
...
ax.fill_between(k, sensitivity, 2000, color='#DDDDDD', alpha=0.4, zorder=0)
ax.text(0.05, 1200, 'HERA Phase II Sensitivity\n(Detectable Region)', 
...
ax.annotate('The Golden Signature\n' + r'$\sim 1500\%$ Boost at $k_* \approx 1$ Mpc$^{-1}$', 
            xy=(k_star, amplitude), xytext=(2.5, 1000),
...
ax.text(k_star, -150, r'$k_* \approx 1$ Mpc$^{-1}$', color='#009E73', ha='center', fontsize=10)
...
# العنوان المعدل (بدون رموز LaTeX معقدة لضمان الظهور الصحيح)
